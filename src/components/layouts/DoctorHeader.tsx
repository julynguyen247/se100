...
import { FiHome, FiUsers, FiFileText, FiClipboard, FiLogOut, FiMenu, FiX } from "react-icons/fi";
import { FaPills } from "react-icons/fa";
import { useNavigate, useLocation } from "react-router-dom";

type TabId = "dashboard" | "queue" | "patients" | "treatment" | "prescription";
...
const TABS: NavTab[] = [
    ...
    { id: "patients", label: "Hồ sơ bệnh nhân", path: "/doctor/patients", icon: FiFileText },
    { id: "treatment", label: "Khám bệnh", path: "/doctor/treatment", icon: FiClipboard },
    { id: "prescription", label: "Kê đơn thuốc", path: "/doctor/prescription", icon: FaPills },
];
