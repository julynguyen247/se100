    ...
    <section className="relative -mt-16 min-h-screen w-full pb-24 font-['Inter','Segoe_UI',system-ui,-apple-system,BlinkMacSystemFont,sans-serif] overflow-hidden">
      ...
      <div className="w-[min(1200px,100%)] mx-auto px-4 pt-16 relative z-10 flex flex-col-reverse gap-10 lg:flex-row-reverse lg:items-center lg:justify-between lg:gap-12">
        ...
        <div className=" w-full max-w-[520px] text-center mx-auto lg:text-left transition-all duration-700 ease-out peer-hover:-translate-y-4 lg:peer-hover:translate-y-0 lg:peer-hover:-translate-x-12  ">
          ...
          <button
            ...
            className="border-none bg-gradient-to-br from-[#2563eb] to-[#1d4ed8] text-white font-semibold py-3.5 px-10 rounded-xl cursor-pointer shadow-[0_20px_36px_rgba(37,99,235,0.35)] transition-all duration-200 w-full sm:w-auto hover:shadow-[0_25px_45px_rgba(37,99,235,0.4)] active:translate-y-[1px]"
          >
            Book Now
          </button>
        </div>
      ...
      <div className="relative z-20 mt-12">
        <div className="w-[min(1200px,100%)] mx-auto px-4">
          ...
          >
            <form onSubmit={handleBookNow} className="flex flex-col gap-6 items-stretch w-full lg:flex-row lg:flex-nowrap lg:items-center lg:w-fit lg:justify-center text-white">
              {/* Các input form */}
              <FormInputControlled
                icon={<FaUser />}
                label="Name"
...
// --- HELPER COMPONENT: FORM INPUT (Controlled) ---
...
const FormInputControlled: React.FC<FormInputControlledProps> = ({
  label,
  placeholder,
  type,
  icon,
