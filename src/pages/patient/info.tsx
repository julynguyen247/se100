        ...
        const fetchData = async () => {
            try {
                ...
                if (genderResponse && genderResponse.data) {
                    const genderLabels = genderResponse.data.map(
                        (item: EnumDto) => mapGenderToVietnamese(item.name)
                    );
                ...
                <ProfileSection title="Thông tin cơ bản">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <Field
                            ...
                            isEditing={isEditing}
                            onChange={(v) =>
                                handleChange('dob', formatDateFromInput(v))
                            }
                            type="date"
                ...
                <ProfileSection title="Thông tin y tế">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                        <TextareaField
                            ...
                            placeholder="Nhập các loại dị ứng, mỗi loại một dòng..."
                            rows={4}
                        ...
                        <TextareaField
                            ...
                            value={
                                isEditing
                                    ? editProfile?.chronicDisease || ''
                                    : profile.chronicDisease || ''
                            }
                            isEditing={isEditing}
                            onChange={(v) => handleChange('chronicDisease', v)}
                            placeholder="Nhập các bệnh lý nền, mỗi bệnh một dòng..."
                            rows={4}
                            icon={<FiHeart className="w-4 h-4" />}
                        />
                    </div>
