...
const AdminReportsPage: React.FC = () => {
    ...
    const [currentMonthNewPatients, setCurrentMonthNewPatients] =
        useState<number>(0);
    ...
    const [previousMonthNewPatients, setPreviousMonthNewPatients] =
        useState<number>(0);
    ...
    const loadReportData = async () => {
        try {
            ...
            const currentStats = historicalData.find(
                (h) => h.period === currentMonth
            );
            const previousStats = historicalData.find(
    ...
    const summaryCards: SummaryCardData[] = useMemo(() => {
        ...
        return [
            ...
            },
            {
                ...
                value: loading
                    ? 'Đang tải...'
                    : `${currentMonthNewPatients.toLocaleString(
                          'vi-VN'
                      )} bệnh nhân`,
    ...
    const handleDownloadDetail = async (id: number) => {
        try {
            ...
            // Error is already logged, UI will show loading state briefly
        }
    };
    ...
    const exportRevenueReport = async (monthName: string) => {
        try {
            ...
            const monthlyBills = billsToExport.filter((bill) => {
                ...
                return (
                    billDate >= currentRangeStart && billDate <= currentRangeEnd
                );
            });
            ...
            const data: any[][] = [
                [
                    `BÁO CÁO DOANH THU CHI TIẾT - THÁNG ${monthName.replace(
                        '_',
                        '/'
                    )}`,
                ],
    ...
    const exportVisitsReport = async (monthName: string) => {
        try {
            ...
            const data: any[][] = [
                [
                    `BÁO CÁO LƯỢT KHÁM CHI TIẾT - THÁNG ${monthName.replace(
                        '_',
                        '/'
                    )}`,
                ],
                ...
                data.push([
                    ...
                    apt.time ||
                        (apt.startAt
                            ...
                            : '—'),
                    apt.endAt
                        ? new Date(apt.endAt).toLocaleTimeString('vi-VN', {
                              hour: '2-digit',
                              minute: '2-digit',
                          })
                        : '—',
    ...
    const exportPatientsReport = async (monthName: string) => {
        try {
            ...
            if (patientsToExport.length === 0) {
                ...
                patientsToExport = allPatients.filter(
                    (patient: PatientItem) => {
                        if (!patient.createdAt) return false;
                        const patientDate = new Date(patient.createdAt);
                        return (
                            patientDate >= currentRangeStart &&
                            patientDate <= currentRangeEnd
                        );
                    }
                );
            }
            ...
            const data: any[][] = [
                [
                    `BÁO CÁO BỆNH NHÂN MỚI - THÁNG ${monthName.replace(
                        '_',
                        '/'
                    )}`,
                ],
    ...
    return (
        <div className="min-h-[calc(100vh-64px)] bg-[#F5F7FB] px-6 py-8 sm:px-10 lg:px-16">
            <div className="max-w-6xl mx-auto space-y-6">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                            <div className="flex items-center justify-between mb-6">
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 mt-1">
                                        Biểu đồ doanh thu và lượt khám trong 6
                                        tháng gần đây
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                            <div className="flex items-center justify-between mb-6">
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 mt-1">
                                        Doanh thu, lượt khám và bệnh nhân mới
                                        theo tháng
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 mt-1">
                                        Phân tích xu hướng doanh thu theo thời
                                        gian
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 mt-1">
                                        Thống kê số lượt khám hoàn thành theo
                                        thời gian
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 mt-1">
                                        Xu hướng tăng trưởng bệnh nhân mới theo
                                        thời gian
                                    </p>
                                </div>
                            </div>
                ...
                <div
                    id="export-reports-section"
                    className="bg-white rounded-2xl shadow-sm border border-slate-100 mt-6"
                >
                    <div className="px-6 py-4 border-b border-slate-100">
                        ...
                        <p className="text-sm text-slate-500 mt-1">
                            Tải xuống báo cáo Excel với đầy đủ thông tin chi
                            tiết
                        </p>
                    </div>
                        ...
                        {detailReports.map((report) => (
                            ...
                            >
                                ...
                                <button
                                    type="button"
                                    onClick={() =>
                                        handleDownloadDetail(report.id)
                                    }
        ...
        >
            <div className="flex items-start justify-between">
                <div className="flex-1">
                    ...
                    <p
                        className={`text-xs font-medium mt-2 ${changeColor} ${
                            loading ? 'animate-pulse' : ''
                        }`}
                    >
                        {change}
